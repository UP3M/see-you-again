<script lang="ts">
	const features = [
		...
		},
		{
			...
			icon: 'phone',
			description:
				'Know more about your new place and Get the best recomendation for your business from our team.'
		},
		{
			title: 'Legalization',
			icon: 'email-blue',
			description:
				'We provide service that can deal with laws and regulations that the startup needs to comply.'
		},
		{
			title: 'Monetization',
			icon: 'monetization',
...
<!-- Hero Section -->
<section
	class="flex flex-col min-h-screen bg-slate-700 text-white bg-center bg-cover bg-blend-overlay bg-fixed bg-black/25"
	style="background-image: url('https://assets.new.siemens.com/siemens/assets/api/uuid:5bf88a2ff3a0fc817e08b9379370a32420f07d7c/width:2000/quality:high/siemens-building-technologies-keyvisual.jpg')"
>
	...
	<div class="flex-1 flex items-center">
		<div class="text-center mx-auto">
			...
			<button class="mx-10 w-1/3 outline bg-black"
				><a href="mailto:m.wedamerta@innopolis.university">Contact Us</a></button
			>
		</div>
	</div>
</section>
		...
		<div class="flex items-center space-x-24">
			<div class="flex flex-col w-1/2">
				<div class="flex flex-col space-y-4">
					<h1 class="text-5xl font-bold font-heading">Start and Expand your company with Us</h1>
					<p class="text-justify">
						The See You Again ecosystem is designed to help you to start and grow your bussiness.
						Set up a perfect workspace and get the best recomendation to expand your company with
						See You Again.
					</p>
				</div>
			...
			<div class="relative w-1/2">
				<img
					...
					class="w-full h-full md:scale-110 object-bottom"
					alt="expansion"
				/>
			</div>
		</div>
	...
	<div class="max-w-screen-lg mx-auto">
		<div class="flex flex-col justify-center text-center">
			<div class="flex flex-col space-y-3">
				...
				<p>
					You take care of the company product/service quality and we take care of everything else
				</p>
			</div>
	...
	<div class="flex flex-col max-w-screen-xl mx-auto space-y-32">
		...
		<div class="flex space-x-24">
			<div class="flex flex-col justify-center w-1/2 space-y-6">
				<h5 class="text-3xl font-semibold">Choose your plan as you wish</h5>
				<p class="text-justify">
					Pick our service that fits your company need. See You Again offer you freedom to choose
					either to pick one of our service as single purchases or you can take full advantage of
					our services by doing full purchases. Full purchases provide you extra services for
					business consultation and market analysis.
				</p>
			...
			<div class="relative w-1/2 flex flex-col items-center md:flex-row md:space-x-10">
				<div
					class="flex flex-col py-8 space-y-3 text-black bg-white px-9 rounded-3xl -top-4 -left-6 text-center"
				>
		...
		<div class="flex space-x-24">
			<div class="relative flex w-1/2">
				<img
					...
					class="w-full h-full"
					alt="Optimized for growth"
				/>
			</div>
			<div class="flex flex-col justify-center w-1/2 space-y-6">
				<h5 class="text-3xl font-semibold">Optimized for growth</h5>
				<p class="text-justify">
					See You Again wants to help every startup that wants to enter a new market by providing a
					product as service in the form of data analysis which will become the basis of information
					in making expansion decisions. See You Again will provide services in the form of Market
					Potential Analyzer, Legal Service, Partnership Finder, Working space Finder, Team Finder
...
<section class="p-10 pt-20 pb-32">
	<div class="flex flex-col justify-center space-y-3 text-center">
		<h2 class="text-4xl font-bold font-heading">Our Partnership Company</h2>
